...
bool servo_service__msg__face_bounding_box__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("servo_service.msg._face_bounding_box.FaceBoundingBox", full_classname_dest, 52) == 0);
  }
  servo_service__msg__FaceBoundingBox * ros_message = _ros_message;
  {  // xmin
...
{
  /* NOTE(esteve): Call constructor of FaceBoundingBox */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("servo_service.msg._face_bounding_box");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FaceBoundingBox");
