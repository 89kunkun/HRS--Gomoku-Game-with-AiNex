...
class JointController:
    ...
    def __init__(self, node : Node):
        ...
        # Joint Position for 'crouch': 
        # [0.0, 0.0, 0.6995279788970947, -2.2116811275482178, -1.487020492553711, 
        # -0.008377579972147942, -0.012566370889544487, -0.004188789986073971, 
        # -0.7162831425666809, 2.249380350112915, 1.4744541645050049, 
        # -0.008377579972147942, -0.6157521605491638, 0.5989969968795776, 
        # -0.2597050070762634, 0.2471386194229126, 0.08377580344676971, 
        # -0.0921533852815628, -1.8346900939941406, 1.82631254196167, 0.0, 
        # -0.004188789986073971, -0.004188789986073971, 0.0]
...
def main(args=None):
    ...
    # joint_names = ['head_pan', 'head_tilt']
    # joint_controller.setJointPositions(joint_names, [0, 0], duration=1.0, unit='deg')
    # time.sleep(1.5)
    # t0 = time.time()
    ...
    #         pan_angle = amplitude_deg * math.sin(2 * math.pi * omega * t)
    #         tilt_angle = 0.0

    #         joint_controller.setJointPositions(
    #             joint_names,
    ...
    #         node.get_logger().info(f"Sine angle: {pan_angle:.2f} deg")

    #         time.sleep(0.02)
    # except KeyboardInterrupt:
    #     node.get_logger().info("Stopping sine motion, resetting...")
    #     joint_controller.setJointPositions(joint_names, [0, 0], 1.0, unit='deg')
    #     time.sleep(1.5)
    #     joint_controller.setPosture('crouch', 0.8)
    #     time.sleep(1.5)
