...
cavpath='/home/hrs2025/20260121/src/ainex_vision/ainex_vision/piece_grid.csv'
...
class PieceArrayOutput(Node):
    def __init__(self):
        ...
        self.pub_array = self.create_publisher(PoseArray, self.array_topic, 10)
